        ...
        <svg viewBox="0 0 69.667 44" xmlns="http://www.w3.org/2000/svg">
          <g transform="translate(3.5 3.5)" data-name="Component 15 – 1" id="Component_15_1">
            ...
            <g fill="#def8ff" transform="translate(3.585 1.325)" id="stars">
              ...
              <path transform="matrix(-0.777, 0.629, -0.629, -0.777, 23.185, 12.358)" d="M1.341.529.836.472.736,0,.505.46,0,.4.729l-.231.46L.605.932l.4.326L.9.786Z" data-name="star"></path>
